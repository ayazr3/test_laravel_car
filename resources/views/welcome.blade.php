            ...
            {{-- <div id="carouselExampleInterval" class="carousel carousel-dark slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                  ...
                  <div class="carousel-item" data-bs-interval="2000">
                    <img src="{{ asset('web-Images/3.png') }}" class="d-block w-100" alt="...">
                  </div>
                  <div class="carousel-item">
                    <img src="{{ asset('web-Images/4.png') }}" class="d-block w-100" alt="...">
                  </div>
                </div>
                ...
                <h2 id="Latest-additions" class="d-flex justify-content-center mt-5 " style="text-shadow: 2px 2px #cfa6a6; font-size:50px;">Latest additions</h2>

                <div class="row row-cols-1 row-cols-md-3 g-4">
                    <div class="col">
                      <div class="card">
                        <img src="{{ asset('web-Images/2.png') }}" class="card-img-top" alt="...">
                        <div class="card-body">
