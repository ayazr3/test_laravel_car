    ...
    <body class="antialiased">
        <nav class="navbar navbar-expand-lg bg-body-tertiary ">
            <div class="container-fluid">
                <img src="{{ asset('Grey and Black Car Rental Service Logo.png') }}" alt="" class="img-fluid"width="50px" height="50px" style="padding-right: 10px">
              <a class="navbar-brand" href="">RIMBERIO</a>
              ...
              <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="#Latest-additions mr-2">Latest additions</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/allCar') }}">All Car</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container mx-auto py-8 m-5">
            ...
            @if($ads->count() > 0)
                <section class="featured-ads py-5 bg-light">
                    <div class="container">
                        <h2 class="text-center mb-5">إعلانات سيارات مميزة</h2>
                        <div class="row">
                            @foreach($ads as $ad)
                                @if($ad->is_public && $ad->end_date >= now())
                                    <div class="col-md-4 m  b-4">
                                        <div class="card h-100">
                                            ...
                                            @endif
                                            <div class="card-body">
                                                <h5 class="card-title">{{ $ad->fullname }}</h5>
                                                <p class="card-text">
                                                    @if($ad->car)
                                                        {{ $ad->car->brand }} {{ $ad->car->model }}
                                                    @endif
                                                </p>
                                                <a href="{{ route('ads.redirect',$ad->id) }}" class="btn btn-primary">
                                                    عرض التفاصيل
                                                </a>
                                            </div>
                                        </div>
            ...
            <section class="regular-cars py-5">
                <div class="container">
                    <h2 class="text-center mb-5">السيارات المتاحة للبيع</h2>
                    <div class="row">
                        @forelse ($regularCars as $car)
                            <div class="col-md-4 mb-4"> <!-- أضفت هنا col-md-4 لجعل 3 أعمدة في الصف -->
                                <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow h-full"> <!-- أضفت h-full -->
                                    <!-- معرض الصور -->
                                    ...
                                    <div class="p-4">
                                        ...
                                        class="btn btn-primary mt-4 inline-block bg-blue-500 text-black px-4 py-2 rounded hover:bg-blue-600">
                                            عرض التفاصيل
                                        </a>
                                        <a href="{{ route('review.create', $car->id) }}" class="btn btn-warning">
                                            تقديم شكوى بخصوص هذه السيارة
                                        </a>
                                    </div>
                                </div>
                            </div>
